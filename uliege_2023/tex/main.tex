...
\begin{itemize}
\item Planning the inspection and maintenance of a structural system can be performed with RL and MARL.

\item Work in progress with Pablo Morato from the reliability engineering community.
...
\item In our current work in progress: simulated deterioration and off-shore wind turbines.

\end{itemize}

\blfootnote{P.G. Morato, K.G. Papakonstantinou, C.P. Andriotis, J.S. Nielsen, P. Rigo, (2022) Optimal inspection and maintenance planning for deteriorating structural components through dynamic Bayesian networks and Markov decision processes
}
\end{frame}
...
\vfill
Example: agents send and receive messages before taking their action, allowing multi-stage communication (several messages before taking action).
\vfill
